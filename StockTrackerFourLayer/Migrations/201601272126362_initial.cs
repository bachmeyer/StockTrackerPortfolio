namespace StockTrackerFourLayer.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Type = c.String(),
                        Active = c.Boolean(nullable: false),
                        Stock_Ticker = c.String(maxLength: 128),
                        User_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Stocks", t => t.Stock_Ticker)
                .ForeignKey("dbo.AspNetUsers", t => t.User_Id)
                .Index(t => t.Stock_Ticker)
                .Index(t => t.User_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transactions", "Stock_Ticker", "dbo.Stocks");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Transactions", new[] { "User_Id" });
            DropIndex("dbo.Transactions", new[] { "Stock_Ticker" });
